...
$sedes = $conexion->query("SELECT id, nombre FROM sedes");
$roles = $conexion->query("SELECT id, nombre FROM rol_empleado");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO empleados (nombre, documento, telefono, id_sede, rol_id) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conexion->prepare($query);
    $stmt->bind_param("sssii", $nombre, $documento, $telefono, $id_sede, $rol_id);

    if ($stmt->execute()) {
        header("Location: empleados.php");
        exit();
    } else {
        $error = "Error al registrar el empleado: " . $stmt->error;
    }
    $stmt->close();
}
?>
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <h2><i class="fas fa-user-plus"></i> Agregar Nuevo Empleado</h2>
            <p>Complete el formulario para registrar un nuevo empleado</p>
        </div>
        ...
        <div class="form-card">
            <form method="POST">
                ...
                <div class="form-group-custom">
                    ...
                    <select class="form-select-custom" id="id_sede" name="id_sede" required>
                ...
                <div class="form-group-custom">
                    ...
                    <select class="form-select-custom" id="rol_id" name="rol_id" required>
